...
class ListaUsuarios : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ArrayAdapter(
            ...
            sqliteHelperUsuario.getAllUsuarios()
        )
    ...
    override fun onCreateContextMenu(
        ...
        val positionUsuarioSelected = info.position
        menu?.findItem(R.id.itemEliminarUsuario)?.isVisible = sqliteHelperUsuario.getAllUsuarios()[positionUsuarioSelected].usuarioBetado
    }
        ...
        return when (item.itemId) {
            ...
            R.id.itemEliminarUsuario -> {
                ...
                builder.setPositiveButton("Sí") { dialog, which ->
                    val usuario = sqliteHelperUsuario.getAllUsuarios()[positionUsuarioSelected]
                    usuario.usuarioBetado = false
